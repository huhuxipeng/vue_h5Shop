<template>
    <div id="helps">
      <mt-header flexd title="帮助中心" class="shop" v-if="indexs==0">
        <mt-button icon="back" @click="backgo" slot="left"></mt-button>
      </mt-header>
      <div class="nav">
        <ul>
          <li v-for="(item,index) in titles" @click="synthesis(item,index)">
            <span :class="{'bor':p==index+1}">{{item.typeName}}</span>
          </li>
          <!--<li @click="yel">-->
